...
7. **Capability/permission edge polish:** camera revoked mid-app; `persist()` denied messaging; speech unavailable degradation (visual-only lap display with warning); wake-lock loss surfacing.
